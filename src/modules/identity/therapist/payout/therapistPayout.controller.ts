...
class TherapistPayoutController {
    requestPayout = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    ...
    getPayouts = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
        const therapistId = req.user.id;
        const payouts = await therapistPayoutService.getPayouts(therapistId);
        res.json(new OkResponse(payouts));
    });

    getPayoutById = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
