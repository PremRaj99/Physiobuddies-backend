...
class TherapistSessionController {
    getTodaySessions = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    ...
    getUpcomingSessions = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
        const therapistId = req.params.therapistId;
