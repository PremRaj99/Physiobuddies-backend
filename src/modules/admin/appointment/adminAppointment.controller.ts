...
class AdminAppointmentController {
  getAllAppointments = asyncHandler(async (_req: Request, res: Response, _next: NextFunction) => {
    // Logic to get all appointments
    res.json(new OkResponse([]));
  });

  getAppointmentById = asyncHandler(async (req: Request, res: Response, _next: NextFunction) => {
