...
export class CronController {
    ...
    expireReservations = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    ...
    settleSessions = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
